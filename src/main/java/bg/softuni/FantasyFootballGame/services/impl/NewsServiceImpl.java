...
public class NewsServiceImpl implements NewsService {
    ...
    public void seedNews() {
        ...
        if (admin.isPresent()) {
            ...
            System.out.println(mappedUser.getNews().size());
